...
namespace HealthGraphNet.Tests.Unit
{
    ...
    public class NutritionEndpointTest
    {
        ...
        public void GetNutrition_UriValid_DoesNotThrowArgumentException()
        {
            ...
            NutritionEndpoint nutritionRequest = new NutritionEndpoint(client.Object, new UsersModel { Nutrition = validPath });
            //Act and assert
        ...
        public void UpdateNutrition_AllPropertiesValid_DoesNotThrowArgumentException()
        {
            //Arrange
            var client = new Mock<ClientStub>();
            NutritionEndpoint nutritionRequest = new NutritionEndpoint(client.Object, new UsersModel());
            //Act and Assert
        ...
        public void CreateNutrition_AllMeasurementsNull_ArgumentException()
        {
            //Arrange
            var client = new Mock<ClientStub>();
            var nutritionRequest = new NutritionEndpoint(client.Object, new UsersModel());
            //Act
